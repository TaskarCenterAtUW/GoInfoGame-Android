...
import com.tcatuw.goinfo.data.user.UserDataController
...
class MessagesSource(
    ...
    *  database table*/
    ...
    fun getNumberOfMessages(): Int {
        ...
        val hasNewVersion = lastVersion != null && com.tcatuw.goinfo.BuildConfig.VERSION_NAME != lastVersion
        if (lastVersion == null) {
            prefs.edit { putString(Prefs.LAST_VERSION, com.tcatuw.goinfo.BuildConfig.VERSION_NAME) }
        }
