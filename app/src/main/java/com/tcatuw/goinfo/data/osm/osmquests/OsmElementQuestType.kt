 ...
 *  elements subclass [OsmFilterQuestType][com.tcatuw.goinfo.data.osm.osmquests.OsmFilterQuestType]
 *  */
interface OsmElementQuestType<T> : QuestType, ElementEditType {
     ...
     *
     *  Use [AllCountriesExcept][com.tcatuw.goinfo.data.quest.AllCountriesExcept] to exclude some countries.
     *  Use [NoCountriesExcept][com.tcatuw.goinfo.data.quest.NoCountriesExcept] to exclude all except some countries.
     *
