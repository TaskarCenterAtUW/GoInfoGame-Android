...
import com.tcatuw.goinfo.data.osm.edits.ElementEditsTable.Columns.ACTION
import com.tcatuw.goinfo.data.osm.edits.ElementEditsTable.Columns.CREATED_TIMESTAMP
import com.tcatuw.goinfo.data.osm.edits.ElementEditsTable.Columns.GEOMETRY
import com.tcatuw.goinfo.data.osm.edits.ElementEditsTable.Columns.ID
import com.tcatuw.goinfo.data.osm.edits.ElementEditsTable.Columns.IS_SYNCED
import com.tcatuw.goinfo.data.osm.edits.ElementEditsTable.Columns.LATITUDE
import com.tcatuw.goinfo.data.osm.edits.ElementEditsTable.Columns.LONGITUDE
import com.tcatuw.goinfo.data.osm.edits.ElementEditsTable.Columns.QUEST_TYPE
import com.tcatuw.goinfo.data.osm.edits.ElementEditsTable.Columns.SOURCE
import com.tcatuw.goinfo.data.osm.edits.ElementEditsTable.NAME
import com.tcatuw.goinfo.data.osm.edits.create.CreateNodeAction
import com.tcatuw.goinfo.data.osm.edits.create.CreateNodeFromVertexAction
import com.tcatuw.goinfo.data.osm.edits.create.RevertCreateNodeAction
import com.tcatuw.goinfo.data.osm.edits.delete.DeletePoiNodeAction
import com.tcatuw.goinfo.data.osm.edits.delete.RevertDeletePoiNodeAction
import com.tcatuw.goinfo.data.osm.edits.move.MoveNodeAction
import com.tcatuw.goinfo.data.osm.edits.move.RevertMoveNodeAction
import com.tcatuw.goinfo.data.osm.edits.split_way.SplitWayAction
import com.tcatuw.goinfo.data.osm.edits.update_tags.RevertUpdateElementTagsAction
