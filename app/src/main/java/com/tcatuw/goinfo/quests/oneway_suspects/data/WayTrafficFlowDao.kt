package com.tcatuw.goinfo.quests.oneway_suspects.data

import com.tcatuw.goinfo.data.Database
import com.tcatuw.goinfo.data.osm.mapdata.WayTables
import com.tcatuw.goinfo.quests.oneway_suspects.data.WayTrafficFlowTable.Columns.IS_FORWARD
import com.tcatuw.goinfo.quests.oneway_suspects.data.WayTrafficFlowTable.Columns.WAY_ID
import com.tcatuw.goinfo.quests.oneway_suspects.data.WayTrafficFlowTable.NAME
