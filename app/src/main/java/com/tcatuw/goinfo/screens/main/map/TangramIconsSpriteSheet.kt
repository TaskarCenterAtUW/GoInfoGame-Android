...
import com.tcatuw.goinfo.util.ktx.createBitmapWithWhiteBorder
...
class TangramIconsSpriteSheet(
    ...
    val sceneUpdates: List<Pair<String, String>> by lazy {
        val isSpriteSheetCurrent = prefs.getInt(Prefs.ICON_SPRITES_VERSION, 0) == com.tcatuw.goinfo.BuildConfig.VERSION_CODE
        val spriteSheet = when {
            !isSpriteSheetCurrent || com.tcatuw.goinfo.BuildConfig.DEBUG -> createSpritesheet()
    ...
    private fun createSpritesheet(): String {
        ...
        prefs.edit {
            putInt(Prefs.ICON_SPRITES_VERSION, com.tcatuw.goinfo.BuildConfig.VERSION_CODE)
