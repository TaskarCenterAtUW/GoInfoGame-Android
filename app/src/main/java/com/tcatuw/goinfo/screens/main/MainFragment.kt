...
import com.tcatuw.goinfo.data.edithistory.EditKey
import com.tcatuw.goinfo.data.edithistory.icon
...
import com.tcatuw.goinfo.data.osmnotes.edits.NotesWithEditsSource
...
import com.tcatuw.goinfo.databinding.EffectQuestPlopBinding
import com.tcatuw.goinfo.databinding.FragmentMainBinding
import com.tcatuw.goinfo.osm.level.createLevelsOrNull
import com.tcatuw.goinfo.osm.level.levelsIntersect
import com.tcatuw.goinfo.overlays.AbstractOverlayForm
import com.tcatuw.goinfo.overlays.IsShowingElement
...
import com.tcatuw.goinfo.quests.IsShowingQuestDetails
import com.tcatuw.goinfo.quests.LeaveNoteInsteadFragment
import com.tcatuw.goinfo.quests.note_discussion.NoteDiscussionForm
import com.tcatuw.goinfo.screens.main.bottom_sheet.CreateNoteFragment
import com.tcatuw.goinfo.screens.main.bottom_sheet.IsCloseableBottomSheet
import com.tcatuw.goinfo.screens.main.bottom_sheet.IsMapOrientationAware
import com.tcatuw.goinfo.screens.main.bottom_sheet.IsMapPositionAware
import com.tcatuw.goinfo.screens.main.bottom_sheet.MoveNodeFragment
import com.tcatuw.goinfo.screens.main.bottom_sheet.SplitWayFragment
import com.tcatuw.goinfo.screens.main.controls.LocationStateButton
import com.tcatuw.goinfo.screens.main.controls.MainMenuButtonFragment
import com.tcatuw.goinfo.screens.main.controls.UndoButtonFragment
import com.tcatuw.goinfo.screens.main.edithistory.EditHistoryFragment
import com.tcatuw.goinfo.screens.main.map.LocationAwareMapFragment
import com.tcatuw.goinfo.screens.main.map.MainMapFragment
import com.tcatuw.goinfo.screens.main.map.MapFragment
import com.tcatuw.goinfo.screens.main.map.ShowsGeometryMarkers
import com.tcatuw.goinfo.screens.main.map.getPinIcon
import com.tcatuw.goinfo.screens.main.map.getTitle
import com.tcatuw.goinfo.screens.main.map.tangram.CameraPosition
import com.tcatuw.goinfo.util.SoundFx
import com.tcatuw.goinfo.util.buildGeoUri
import com.tcatuw.goinfo.util.ktx.childFragmentManagerOrNull
import com.tcatuw.goinfo.util.ktx.dpToPx
import com.tcatuw.goinfo.util.ktx.getLocationInWindow
import com.tcatuw.goinfo.util.ktx.hasLocationPermission
import com.tcatuw.goinfo.util.ktx.hideKeyboard
import com.tcatuw.goinfo.util.ktx.isLocationEnabled
import com.tcatuw.goinfo.util.ktx.setMargins
import com.tcatuw.goinfo.util.ktx.toLatLon
import com.tcatuw.goinfo.util.ktx.toast
import com.tcatuw.goinfo.util.ktx.truncateTo5Decimals
import com.tcatuw.goinfo.util.ktx.viewLifecycleScope
import com.tcatuw.goinfo.util.location.FineLocationManager
import com.tcatuw.goinfo.util.location.LocationAvailabilityReceiver
import com.tcatuw.goinfo.util.location.LocationRequestFragment
import com.tcatuw.goinfo.util.math.area
import com.tcatuw.goinfo.util.math.enclosingBoundingBox
import com.tcatuw.goinfo.util.math.enlargedBy
import com.tcatuw.goinfo.util.math.initialBearingTo
import com.tcatuw.goinfo.util.viewBinding
import com.tcatuw.goinfo.view.insets_animation.respectSystemInsets
