...
import com.tcatuw.goinfo.ApplicationConstants.COPYRIGHT_YEARS
import com.tcatuw.goinfo.R
import com.tcatuw.goinfo.databinding.CellLabeledIconSelectRightBinding
import com.tcatuw.goinfo.databinding.DialogDonateBinding
...
class AboutFragment : TwoPaneListFragment(), HasTitle {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<Preference>("version")?.summary =
            getString(R.string.about_summary_current_version, "v" + com.tcatuw.goinfo.BuildConfig.VERSION_NAME)
    ...
    private fun showDonateDialog() {
        ...
        if (!com.tcatuw.goinfo.BuildConfig.IS_GOOGLE_PLAY) {
