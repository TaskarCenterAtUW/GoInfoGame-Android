...
class MultiSelectPinMapComponent(private val ctx: Context, private val ctrl: KtMapController) {
    ...
    companion object {
        ...
        private const val SELECTED_PINS_LAYER = "streetcomplete_multi_selected_pins"
    }
}
