...
import com.tcatuw.goinfo.osm.opening_hours.model.Weekdays.Companion.getWeekdayIndex
...
class CountryInfosTest {
    ...
    private fun checkFirstDayOfWorkweekIsValid(info: com.tcatuw.goinfo.data.meta.CountryInfo) {
    ...
    private fun checkAdditionalValidHousenumberRegexes(infos: Map<String, com.tcatuw.goinfo.data.meta.CountryInfo>) {
    ...
    private fun checkRegularShoppingDaysIsBetween0And7(info: com.tcatuw.goinfo.data.meta.CountryInfo) {
    ...
    private fun getAllCountryInfos(): Map<String, com.tcatuw.goinfo.data.meta.CountryInfo> {
        val assetManager = InstrumentationRegistry.getInstrumentation().targetContext.assets
        val countryInfos = com.tcatuw.goinfo.data.meta.CountryInfos(assetManager)
